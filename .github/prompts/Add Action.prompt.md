...
**File:** `custom_components/volkswagen_goconnect/services.yaml`
...
Create `custom_components/volkswagen_goconnect/service_actions/[action_name].py`:
...
**File:** `custom_components/volkswagen_goconnect/__init__.py`
...
**File:** `custom_components/volkswagen_goconnect/const.py`
...
3. Find service action: `volkswagen_goconnect.[action_name]`
...
- **Service actions directory:** `custom_components/volkswagen_goconnect/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/volkswagen_goconnect/services.yaml` (legacy filename)
- **Icons:** `custom_components/volkswagen_goconnect/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/volkswagen_goconnect/translations/*.json` under `services` key (legacy)
