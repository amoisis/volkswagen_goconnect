...
- Inherit from `VolkswagenGoConnectEntity` and platform base class
- Ensure `device_info` property returns same identifiers as other entities on this device
- Coordinate device_info generation via `entity_utils/device_info.py` helper for consistent device grouping
...
- Entity: `custom_components/volkswagen_goconnect/[platform]/[entity_name].py`
- Platform: `custom_components/volkswagen_goconnect/[platform]/__init__.py`
- Device Info Helper: `custom_components/volkswagen_goconnect/entity_utils/device_info.py`
- Translations: `custom_components/volkswagen_goconnect/strings.json`
- Documentation: Reference `docs/development/ARCHITECTURE.md`
